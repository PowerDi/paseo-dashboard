...
import { DashboardAccountSection } from "@/dashboard";
...
const SIDEBAR_SECTION_ITEMS: SidebarSectionItem[] = [
  { id: "account", labelKey: "settings.sections.account", icon: UserRound },
...
export default function SettingsScreen({ view, openAddHostIntent = null }: SettingsScreenProps) {
  ...
  const content = (() => {
    ...
    if (view.kind === "section") {
      switch (view.section) {
        case "account":
          return <DashboardAccountSection onPairHost={handleAddHost} />;
        case "general":
          return (
            <>
              <GeneralSection
