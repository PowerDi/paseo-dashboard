...
import { DashboardLoginGate, DashboardSessionProvider } from "@/dashboard";
import { DashboardAccountHostRuntimeBridge } from "@/runtime/dashboard-account-bridge";
import {
  getHostRuntimeStore,
      ...
      <View style={layoutStyles.surfaceFill}>
        <RootProviders>
          <DashboardSessionProvider>
            <DashboardAccountHostRuntimeBridge />
            <DashboardLoginGate>
              <RuntimeProviders>
                <AppShell />
              </RuntimeProviders>
