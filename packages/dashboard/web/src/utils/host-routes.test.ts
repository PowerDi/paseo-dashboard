...
describe("settings section slugs", () => {
  it("includes the Dashboard account settings entry", () => {
    expect(isSettingsSectionSlug("account")).toBe(true);
    expect(buildSettingsSectionRoute("account")).toBe("/settings/account");
  });
